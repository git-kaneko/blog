...
1. Use the Astro CLI to create a new project:
   ...
   ```bash
   pnpm create astro@latest -- --template larry-xue/astro-zen-blog
   cd ./to_your_project
   ```
...
To create a new blog post, this template provide an pnpm scripts to help you create a new post:
